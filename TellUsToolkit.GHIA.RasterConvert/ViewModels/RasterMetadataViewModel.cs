...
namespace TellUsToolkit.GHIA.RasterConverter.ViewModels {
  ...
  /// <summary>
  /// The view model used by the <see cref="Views.RasterMetadataView">RasterMetadataView</see>.
  /// </summary>
  public sealed class RasterMetadataViewModel : BaseViewModel<RasterMetadataModel>, IViewModelMethods {
    ...
    /// <summary>
    /// Initializes the <see cref="RasterMetadataViewModel"/>.
    /// </summary>
    /// <param name="rasterMetadataModel">The <see cref="RasterMetadataModel"/> used against this view model.</param>
    public RasterMetadataViewModel(RasterMetadataModel rasterMetadataModel)
      : base(rasterMetadataModel) {
    ...
    private const string _name = "RasterMetadataViewModel";
